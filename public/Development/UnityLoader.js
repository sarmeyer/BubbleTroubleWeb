...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'BubbleWebGLDevBuild.data';
    var REMOTE_PACKAGE_BASE = 'BubbleWebGLDevBuild.data';
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 3180236;
      var PACKAGE_UUID = '6d22001d-1a78-4d73-8357-b0b491c87962';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 320447, 0, 0).open('GET', '/data.unity3d');
    new DataRequest(320447, 320701, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(320701, 326859, 0, 0).open('GET', '/preserved_derived_types.xml');
    new DataRequest(326859, 2277639, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(2277639, 3152611, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(3152611, 3180236, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
    ...
    function processPackageData(arrayBuffer) {
      ...
      DataRequest.prototype.byteArray = byteArray;
          ...
          Module['removeRunDependency']('datafile_BubbleWebGLDevBuild.data');

    };
    Module['addRunDependency']('datafile_BubbleWebGLDevBuild.data');
